      ...
      <div className="max-w-4xl mx-auto px-4 py-12 space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          <p className="text-sm text-gray-600 leading-relaxed">
            At <span className="font-semibold text-[#2563eb]">Suraksha Market</span>, we stand behind every product we deliver. Each item is inspected before dispatch to meet our quality standards. However, if your order does not meet your expectations, we ensure a smooth and transparent resolution process — no hassle, no stress.
          </p>
        </div>
          ...
          <div className="grid sm:grid-cols-2 gap-3">
            {[
              ...
              <div key={i} className="bg-gray-50 rounded-xl p-3 border border-gray-100">
                ...
                <p className="text-xs text-[#2563eb] font-medium mt-0.5">{row.value}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="bg-[#1e40af] rounded-2xl p-6 relative overflow-hidden">
          ...
          <p className="relative z-10 text-sm text-blue-200 leading-relaxed italic text-center max-w-2xl mx-auto">
            At <span className="text-[#2563eb] font-semibold not-italic">Suraksha Market</span>, every return is an opportunity to reaffirm our promise of quality, trust, and unmatched service. We are not satisfied until you are.
          </p>
        </div>
