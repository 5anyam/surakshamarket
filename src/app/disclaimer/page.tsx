  ...
  },
  {
    ...
    content: (
      <div className="space-y-3 text-sm text-gray-600 leading-relaxed">
        <p>
          Suraksha Market shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from or related to the use of the Platform, products, or services, including but not limited to loss of data, profits, or business opportunities.
        </p>
        <p>
    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <section className="bg-[#1e40af] py-14 px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <p className="text-blue-200 text-sm leading-relaxed max-w-2xl">
            Important legal information regarding the use of the Suraksha Market platform and products.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          <p className="text-sm text-gray-600 leading-relaxed">
            Welcome to <span className="font-semibold text-[#2563eb]">Suraksha Market</span>, India is growing online marketplace for Electronics, Fashion, Home & Living, and more. This Disclaimer outlines the limitations of our liability and the terms under which you may use our website at{' '}
        ...
        {/* CTA footer */}
        <div className="bg-[#1e40af] rounded-2xl p-8 text-white text-center relative overflow-hidden">
          <div className="absolute top-0 right-0 w-48 h-48 bg-[#2563eb]/10 rounded-full blur-3xl pointer-events-none" />
          <div className="relative z-10">
            <div className="w-14 h-14 bg-[#2563eb] rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-orange-500/30">
            ...
            <p className="text-sm text-blue-200 max-w-xl mx-auto leading-relaxed mb-5">
              At Suraksha Market, transparency builds trust. This Disclaimer ensures you understand the terms of using our Platform, so you can shop with complete confidence.
            </p>
            <Link
              href="/shop"
              className="inline-flex items-center gap-2 px-6 py-3 bg-[#2563eb] hover:bg-[#1d4ed8] text-white rounded-xl text-sm font-bold uppercase tracking-wide transition-all shadow-lg hover:shadow-orange-500/30"
            >
