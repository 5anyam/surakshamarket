  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-2 px-8 py-3.5 bg-white border-2 border-[#1e40af] text-[#1e40af] hover:bg-[#1e40af] hover:text-white rounded-xl text-sm font-bold uppercase tracking-wide transition-all duration-300"
      >
        Get in Touch
      </button>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                {fields.map((field) => (
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 border-2 border-gray-100 rounded-xl focus:outline-none focus:border-[#2563eb] focus:ring-2 focus:ring-[#2563eb]/10 text-sm bg-gray-50 transition-all"
                  />
                ))}
                <textarea
                  ...
                  required
                  className="w-full px-4 py-3 border-2 border-gray-100 rounded-xl focus:outline-none focus:border-[#2563eb] focus:ring-2 focus:ring-[#2563eb]/10 text-sm bg-gray-50 resize-none transition-all"
                />
                <button
                  type="submit"
                  className="w-full bg-[#2563eb] hover:bg-[#1d4ed8] text-white py-3.5 rounded-xl text-sm font-bold uppercase tracking-wide transition-all shadow-md hover:shadow-lg hover:shadow-orange-200"
                >
                  Send Message
                </button>
              </form>
...
function StatCard({ value, label, icon: Icon }: StatCardProps) {
  return (
    <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm text-center hover:border-[#2563eb]/20 hover:shadow-md transition-all duration-300">
...
export default function AboutPage() {
  ...
  const categories: CategoryItem[] = [
    ...
    { icon: Headphones, title: 'Audio & Accessories', desc: 'Headphones, earbuds, cables, chargers, and mobile accessories.', color: 'bg-orange-50 text-[#2563eb]' },
  ];
  ...
  return (
    <main className="bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 py-16 space-y-16">
        ...
        {/* ── HERO ── */}
        <section className="bg-[#1e40af] rounded-3xl px-8 md:px-16 py-16 text-white text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-4xl lg:text-6xl font-bold mb-5 tracking-tight">
              About <span className="text-[#2563eb]">Suraksha Market</span>
            </h1>
          ...
          <div className="grid md:grid-cols-2 gap-0">
            <div className="bg-gradient-to-br from-orange-50 to-[#FFF8F3] flex items-center justify-center p-12 min-h-[300px]">
              <div className="text-center">
                <div className="w-24 h-24 bg-[#2563eb] rounded-3xl flex items-center justify-center mx-auto mb-5 shadow-xl shadow-orange-200">
            ...
            <div className="p-10 flex flex-col justify-center">
              <div className="inline-flex items-center gap-2 bg-orange-50 rounded-full px-3 py-1 mb-4 w-fit">
                <span className="text-[10px] font-bold text-[#2563eb] uppercase tracking-wider">Our Foundation</span>
              </div>
              <h2 className="text-2xl lg:text-3xl font-bold mb-4 text-gray-900">
                Built for Every Indian Shopper
              </h2>
              <p className="text-sm text-gray-600 mb-4 leading-relaxed">
                Suraksha Market was founded with one simple mission: make online shopping in India easier, more reliable, and more enjoyable. We believe every customer deserves access to genuine products, fast delivery, and honest service — without compromise.
              </p>
        ...
        <section>
          <div className="text-center mb-10">
            <div className="inline-flex items-center gap-2 bg-[#2563eb]/10 border border-[#2563eb]/20 rounded-full px-4 py-1.5 mb-4">
              <span className="text-xs font-semibold text-[#2563eb] uppercase tracking-wider">Our Categories</span>
            </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {categories.map((item, i) => (
              <div
                key={i}
                className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm hover:border-[#2563eb]/20 hover:shadow-md transition-all duration-300 group"
              >
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-orange-50 rounded-full px-3 py-1 mb-4">
                <span className="text-[10px] font-bold text-[#2563eb] uppercase tracking-wider">Our Advantage</span>
              </div>
              <h2 className="text-2xl lg:text-3xl font-bold mb-7 text-gray-900">Why Shop on Suraksha Market?</h2>
              <div className="space-y-5">
                {whyItems.map((item, i) => (
                  <div key={i} className="flex items-start gap-4 group">
                    <div className="w-10 h-10 bg-orange-50 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:bg-[#2563eb] transition-colors duration-300">
            ...
            {/* Commitments card */}
            <div className="bg-gradient-to-br from-[#1e40af] to-[#243560] rounded-2xl p-8 text-white relative overflow-hidden">
              <div className="absolute top-0 right-0 w-40 h-40 bg-[#2563eb]/10 rounded-full blur-2xl pointer-events-none" />
        ...
        <section className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 md:p-12 text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-sm text-gray-500 mb-5 leading-relaxed">
              Suraksha Market is more than a marketplace — it is a community of smart shoppers. Follow us on social media for exclusive deals, new arrivals, and shopping tips. Your feedback shapes what we stock next!
            </p>
            <p className="text-sm text-gray-700 font-semibold italic">
              &quot;Shop smart. Shop genuine. Shop Suraksha Market.&quot;
            </p>
          </div>
        </section>

        {/* ── CTA ── */}
        <section className="bg-[#1e40af] rounded-2xl p-10 md:p-14 text-white text-center relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/shop"
                className="inline-flex items-center justify-center gap-2 px-8 py-3.5 bg-[#2563eb] hover:bg-[#1d4ed8] text-white rounded-xl text-sm font-bold uppercase tracking-wide transition-all shadow-lg hover:shadow-orange-500/30"
              >
