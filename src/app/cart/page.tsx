      ...
      <div className="bg-gray-50 border-b border-gray-200">
        <div className="max-w-6xl mx-auto px-4 py-10">
          <div className="flex items-center gap-3 mb-1">
            ...
            <h1 className="text-2xl font-sora font-bold text-gray-900 tracking-tight">Shopping Cart</h1>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        {items.length === 0 ? (
          <div className="text-center py-20 bg-gray-50 border border-gray-200">
            <div className="w-20 h-20 bg-white border border-gray-200 flex items-center justify-center mx-auto mb-5">
              <ShoppingBag className="w-9 h-9 text-gray-300" />
            </div>
            <h2 className="text-lg font-sora font-bold text-gray-900 mb-2">Your cart is empty</h2>
            <p className="text-sm text-gray-500 mb-7 max-w-xs mx-auto leading-relaxed">
              Add products to your cart and they will appear here.
            </p>
            <Link
              href="/collections"
              className="inline-flex items-center gap-2 px-7 py-3 bg-[#2563eb] hover:bg-[#1d4ed8] text-white text-sm font-bold uppercase tracking-wide transition-colors"
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-3">
              {items.map((item) => {
                ...
                return (
                  <div
                    key={item.id}
                    className="bg-white border border-gray-200 hover:border-gray-300 p-4 sm:p-5 transition-all duration-200"
                  >
                    <div className="flex gap-4">
                      {/* Image */}
                      <div className="flex-shrink-0 w-20 h-20 bg-gray-50 border border-gray-200 overflow-hidden relative">
                        {item.images?.[0]?.src ? (
                          <Image
                        ...
                        <div className="flex items-center justify-between pt-1">
                          <div className="flex items-center border border-gray-200 overflow-hidden">
                            <button
                              ...
                              className="px-3 py-2 hover:bg-[#2563eb] hover:text-white disabled:opacity-30 disabled:cursor-not-allowed transition-colors text-gray-400"
                            >
                              <Minus className="w-3.5 h-3.5" />
                            </button>
                            <span className="w-10 text-center text-sm font-bold text-gray-900 border-x border-gray-200 py-2">
                              {item.quantity}
                            </span>
                            <button
                              type="button"
                              onClick={(e) => { e.preventDefault(); e.stopPropagation(); increment(item.id); }}
                              className="px-3 py-2 hover:bg-[#2563eb] hover:text-white transition-colors text-gray-400"
                            >
              ...
              <Link
                href="/collections"
                className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-[#2563eb] font-medium mt-2 transition-colors"
              >
                ← Continue Shopping
              </Link>
            </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-white border border-gray-200 sticky top-8 shadow-sm">
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="space-y-3">
                    <Link
                      href="/checkout"
                      className="w-full inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-[#2563eb] hover:bg-[#1d4ed8] text-white text-sm font-bold uppercase tracking-wide transition-colors"
                    >
                      Proceed to Checkout
                      <ArrowRight className="w-4 h-4" />
                    </Link>
                    <Link
                      href="/collections"
                      className="w-full inline-flex items-center justify-center gap-2 px-6 py-3 border border-gray-200 hover:border-[#2563eb] text-gray-500 hover:text-[#2563eb] text-sm font-medium transition-all"
                    >
                      Continue Shopping
                    </Link>
                  </div>
