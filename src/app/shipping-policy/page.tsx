      ...
      <div className="max-w-4xl mx-auto px-4 py-12 space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          <p className="text-sm text-gray-600 leading-relaxed mb-3">
            At <span className="font-semibold text-[#2563eb]">Suraksha Market</span>, we understand that a seamless shopping experience extends beyond your purchase — it is about timely, secure, and transparent delivery every step of the way.
          </p>
        ...
        <div className="space-y-4">
          {shippingItems.map((item, index) => (
            <div
              key={index}
              className="group bg-white rounded-2xl border border-gray-100 shadow-sm p-6 hover:border-[#2563eb]/20 hover:shadow-md transition-all duration-300"
            >
              <div className="flex items-start gap-4">
                <div className="w-11 h-11 bg-orange-50 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:bg-[#2563eb] transition-colors duration-300">
                  <item.icon className="w-5 h-5 text-[#2563eb] group-hover:text-white transition-colors duration-300" />
                </div>
                <div className="flex-1">
                  <div className="flex items-start justify-between gap-2 mb-1.5">
                    <h3 className="text-sm font-bold text-gray-900">{item.title}</h3>
                    <span className="text-[10px] font-bold text-[#2563eb] bg-orange-50 px-2.5 py-1 rounded-full flex-shrink-0 border border-[#2563eb]/20">
                      {item.highlight}
                    </span>
                  </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {[
              ...
              <div
                key={index}
                className="text-center p-5 bg-gray-50 rounded-xl border border-gray-100 hover:border-[#2563eb]/20 hover:shadow-sm transition-all"
              >
                <div className="text-3xl mb-2">{area.icon}</div>
                <h4 className="text-sm font-bold text-gray-900 mb-1">{area.region}</h4>
                <p className="text-xs text-[#2563eb] font-semibold mb-2">{area.time}</p>
        ...
        {/* Closing quote */}
        <div className="bg-[#1e40af] rounded-2xl p-6 relative overflow-hidden">
          ...
          <p className="relative z-10 text-sm text-blue-200 leading-relaxed italic text-center max-w-2xl mx-auto">
            At <span className="text-[#2563eb] font-semibold not-italic">Suraksha Market</span>, every shipment is more than a parcel — it is a promise delivered with care, speed, and reliability.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 md:p-8">
          ...
          <div className="space-y-3">
            {faqItems.map((faq, index) => (
              <details
                key={index}
                className="group border border-gray-100 rounded-xl overflow-hidden hover:border-[#2563eb]/20 transition-all"
              >
                <summary className="px-5 py-4 cursor-pointer flex items-center justify-between text-sm font-semibold text-gray-900 bg-gray-50 hover:bg-orange-50/30 transition-colors list-none">
                  ...
                  <ChevronRight className="w-4 h-4 text-[#2563eb] flex-shrink-0 group-open:rotate-90 transition-transform duration-200" />
                </summary>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-[#2563eb] hover:bg-[#1d4ed8] text-white rounded-xl text-sm font-bold uppercase tracking-wide transition-all shadow-md hover:shadow-lg hover:shadow-orange-200"
            >
        ...
        <p className="text-xs text-gray-400 text-center pb-4">
          ...
          <Link href="/returns-and-refunds-policy" className="text-[#2563eb] hover:underline">Return Policy</Link>
          {' '}&nbsp;·&nbsp;{' '}
          <Link href="/cancellation-policy" className="text-[#2563eb] hover:underline">Cancellation Policy</Link>
        </p>
      </div>
    </main>
  );
