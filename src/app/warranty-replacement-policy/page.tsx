    ...
    content: (
      <div className="space-y-3">
        <p className="text-sm text-gray-600 leading-relaxed">
          All Suraksha Market products come with a warranty covering manufacturing defects and material failures under normal use conditions.
        </p>
        <ul className="space-y-2">
          {[
            '30-day warranty on all products sold on Suraksha Market',
        ...
        <ol className="space-y-3">
          {replacementSteps.map((item, i) => (
            <li key={i} className="flex gap-4 items-start">
              <div className="flex-shrink-0 w-9 h-9 bg-[#2563eb] rounded-xl flex items-center justify-center text-xs font-bold text-white">
                {item.step}
              </div>
              <div>
      ...
      <div className="grid sm:grid-cols-3 gap-3">
        {[
          ...
          <div key={i} className="text-center p-3 bg-gray-50 rounded-xl border border-gray-100">
            ...
            <p className="text-sm font-bold text-[#2563eb]">{row.value}</p>
          </div>
        ))}
      </div>
    ),
    ...
    content: (
      <ul className="space-y-2">
        {[
          ...
          'Final decision on warranty claims rests with the Suraksha Market quality team',
        ].map((item, i) => (
          <li key={i} className="flex items-start gap-2 text-sm text-gray-600">
            <span className="w-1.5 h-1.5 bg-[#2563eb] rounded-full flex-shrink-0 mt-2" />
            {item}
...
const relatedPolicies: PolicyLink[] = [
  ...
  },
  {
    ...
    description: 'Read the full legal terms governing your use of Suraksha Market.',
    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          <p className="text-sm text-gray-600 leading-relaxed">
            At <span className="font-semibold text-[#2563eb]">Suraksha Market</span>, we believe in the quality and durability of every product on our platform. Our warranty and replacement policy ensures you receive the protection and support you deserve, backed by our commitment to customer satisfaction.
          </p>
        </div>
        ...
        {/* Closing quote */}
        <div className="bg-[#1e40af] rounded-2xl p-7 text-center relative overflow-hidden">
          ...
          <p className="relative z-10 text-sm text-blue-200 leading-relaxed italic max-w-2xl mx-auto">
            At <span className="text-[#2563eb] font-semibold not-italic">Suraksha Market</span>, we are committed to providing not just products, but peace of mind. Our warranty policy reflects our confidence in the quality we deliver and our dedication to your satisfaction.
          </p>
        </div>
        ...
        <p className="text-xs text-gray-400 text-center pb-4">
          ...
          <Link href="/terms-and-conditions" className="text-[#2563eb] hover:underline">Terms & Conditions</Link>
          {' '}&nbsp;·&nbsp;{' '}
