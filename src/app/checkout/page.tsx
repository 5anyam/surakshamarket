...
export default function Checkout(): React.ReactElement {
  ...
  const inputClass = (hasError?: string) =>
    `w-full px-4 py-3 border-2 rounded-xl bg-gray-50 text-sm text-gray-900 focus:outline-none focus:bg-white transition-all placeholder:text-gray-400 ${
      hasError ? "border-red-300 focus:border-red-400 focus:ring-2 focus:ring-red-100" : "border-gray-100 focus:border-[#2563eb] focus:ring-2 focus:ring-[#2563eb]/10"
    }`;
      ...
      <main className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="text-center max-w-sm space-y-5">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-7 py-3 bg-[#2563eb] hover:bg-[#1d4ed8] text-white rounded-xl text-sm font-bold uppercase tracking-wide transition-all shadow-md"
          >
  ...
  return (
    <main className="min-h-screen bg-gray-50 pb-12">
      ...
      {/* ── HERO ── */}
      <div className="bg-[#1e40af] relative overflow-hidden">
        ...
        <div className="max-w-2xl mx-auto px-4 py-10 relative z-10">
          <div className="flex items-center gap-3 mb-1">
            <div className="w-9 h-9 bg-[#2563eb] rounded-xl flex items-center justify-center shadow-lg shadow-orange-500/30">
              <Lock className="w-4 h-4 text-white" />
            </div>
            <h1 className="text-2xl font-bold text-white">Secure Checkout</h1>
          </div>
          <p className="text-blue-200 text-sm pl-12">Complete your purchase on <span className="text-[#2563eb] font-semibold">Suraksha Market</span></p>
        </div>
      </div>
      ...
      <div className="max-w-2xl mx-auto px-4 py-8 space-y-5">
        ...
        {/* Auth banners */}
        {!user ? (
          <div className="flex items-center gap-3 p-4 bg-orange-50 border border-[#2563eb]/20 rounded-2xl">
            <User className="w-4 h-4 text-[#2563eb] flex-shrink-0" />
            <p className="text-sm text-gray-700">
              Already have an account?{" "}
              <Link href="/login" className="text-[#2563eb] font-bold hover:underline">Login here</Link>{" "}
        ...
        {/* ── COUPON ── */}
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          <div className="bg-[#2563eb] px-6 py-4 text-center">
        ...
        <form onSubmit={handleCheckout}>
          <SectionCard title="Delivery Information">
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">Name <span className="text-[#2563eb]">*</span></label>
                  <input name="name" value={form.name} onChange={onChange} className={inputClass(errors.name)} placeholder="Full name" required />
                  <FieldError msg={errors.name} />
                </div>
                <div>
                  <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">Email <span className="text-[#2563eb]">*</span></label>
                ...
                <div>
                  <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">Phone <span className="text-[#2563eb]">*</span></label>
                ...
                <div>
                  <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">
                    WhatsApp <span className="text-[#2563eb]">*</span>
              ...
              <div>
                <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">Address <span className="text-[#2563eb]">*</span></label>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">Pincode <span className="text-[#2563eb]">*</span></label>
                ...
                <div>
                  <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">City <span className="text-[#2563eb]">*</span></label>
                  <input name="city" value={form.city} onChange={onChange} className={inputClass(errors.city)} placeholder="City" required />
                  <FieldError msg={errors.city} />
                </div>
                <div>
                  <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">State <span className="text-[#2563eb]">*</span></label>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 mt-5 space-y-4">
            ...
            <button
              ...
              className="w-full bg-[#2563eb] hover:bg-[#1d4ed8] disabled:opacity-60 disabled:cursor-not-allowed text-white py-4 rounded-xl text-sm font-bold uppercase tracking-wide transition-all shadow-md hover:shadow-lg hover:shadow-orange-200 flex items-center justify-center gap-2"
            >
              ) : paymentMethod === cod ? (
  <>
    ...
    <ArrowRight className="w-4 h-4" />
            ...
            <div className="flex items-center justify-center gap-5 text-xs text-gray-400 pt-1">
              {["SSL Secured", "Encrypted Payments", "Free Delivery"].map((t) => (
                <span key={t} className="flex items-center gap-1"><CheckCircle className="w-3 h-3 text-[#2563eb]" />{t}</span>
              ))}
            </div>
          </div>
        </form>
