...
const sections = [
  ...
  },
  {
    ...
    content: (
      <ul className="space-y-2 text-sm text-gray-600 leading-relaxed">
        {[
          'When you purchase products or create an account on Suraksha Market',
      ...
      <section className="bg-[#1e40af] py-14 px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <p className="text-blue-200 text-sm leading-relaxed max-w-2xl">
            At Suraksha Market, we are committed to protecting your personal information and ensuring transparency about how we collect, use, and safeguard your data.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          <p className="text-sm text-gray-600 leading-relaxed mb-3">
            <span className="font-semibold text-[#2563eb]">Suraksha Market</span> (Company, we, our, or us) is committed to protecting your privacy as you shop across our wide range of Electronics, Fashion, Home & Living, Beauty, and more. This Privacy Policy outlines how we collect, use, disclose, and safeguard your Personal Information through our platform at{' '}
        ...
        <div className="bg-[#1e40af] rounded-2xl p-8 text-white text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-sm text-blue-200 max-w-xl mx-auto leading-relaxed mb-5">
              At Suraksha Market, we safeguard your personal information with the highest standards of security and privacy — so you can shop with complete confidence.
            </p>
            <Link
              href="/shop"
