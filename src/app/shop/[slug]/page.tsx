      ...
      <div className="bg-[#1e40af] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 py-12 relative z-10">
          ...
          <div className="flex items-center gap-3 mb-3">
            <div className="w-9 h-9 bg-[#2563eb] rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg shadow-orange-500/30">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3">
            ...
            <div className="relative w-full sm:w-80">
              ...
              <input
                ...
                className="w-full pl-10 pr-9 py-2.5 border-2 border-gray-100 rounded-xl bg-gray-50 text-sm text-gray-900 focus:outline-none focus:border-[#2563eb] focus:ring-2 focus:ring-[#2563eb]/10 focus:bg-white transition-all placeholder:text-gray-400"
              />
              {searchQuery && (
                <button
            ...
            <div className="flex items-center gap-3 w-full sm:w-auto ml-auto">
              ...
              <div className="relative">
                <select
                  ...
                  className="appearance-none pl-3 pr-8 py-2.5 border-2 border-gray-100 rounded-xl bg-gray-50 text-xs font-semibold text-gray-700 focus:outline-none focus:border-[#2563eb] focus:ring-2 focus:ring-[#2563eb]/10 cursor-pointer transition-all"
                >
              ...
              <div className="flex items-center border-2 border-gray-100 rounded-xl overflow-hidden bg-gray-50">
                <button
                  ...
                  className={`p-2.5 transition-colors ${
                    viewMode === 'grid' ? 'bg-[#2563eb] text-white' : 'text-gray-400 hover:text-[#2563eb]'
                  }`}
                ...
                <button
                  ...
                  className={`p-2.5 transition-colors ${
                    viewMode === 'list' ? 'bg-[#2563eb] text-white' : 'text-gray-400 hover:text-[#2563eb]'
                  }`}
        ...
        {isError && (
          <div className="text-center py-20 bg-white rounded-2xl border border-gray-100 shadow-sm">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-[#2563eb] hover:bg-[#1d4ed8] text-white rounded-xl text-sm font-bold uppercase tracking-wide transition-all shadow-md"
            >
              Retry
            </button>
          </div>
