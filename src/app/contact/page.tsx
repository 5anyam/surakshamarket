      ...
      <div className="max-w-7xl mx-auto px-4 py-16 space-y-16">
        ...
        <section className="text-center py-10">
          <div className="inline-flex items-center gap-2 bg-[#2563eb]/10 border border-[#2563eb]/20 rounded-full px-4 py-1.5 mb-5">
            ...
            <span className="text-xs font-semibold text-[#2563eb] uppercase tracking-wider">Get in Touch</span>
          </div>
          ...
          {[
            {
              ...
              cta: <a href="mailto:support@surakhshamarket.in" className="text-xs font-semibold text-[#2563eb] hover:underline">support@surakhshamarket.in</a>,
              color: 'bg-orange-50 text-[#2563eb]',
            },
            {
              icon: <Phone className="w-6 h-6" />,
              label: 'Call Us',
              desc: 'Speak directly with our support team',
              cta: <a href="tel:+919911636888" className="text-xs font-semibold text-[#2563eb] hover:underline">+91 9911636888</a>,
              color: 'bg-orange-50 text-[#2563eb]',
            },
            {
            ...
            <div key={i} className="bg-white rounded-2xl p-7 border border-gray-100 shadow-sm hover:shadow-md hover:border-[#2563eb]/20 transition-all duration-300 group">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border-2 border-gray-100 rounded-xl focus:outline-none focus:border-[#2563eb] focus:ring-2 focus:ring-[#2563eb]/10 transition-all text-sm text-gray-900 bg-gray-50"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-100 rounded-xl focus:outline-none focus:border-[#2563eb] focus:ring-2 focus:ring-[#2563eb]/10 transition-all text-sm text-gray-900 resize-none bg-gray-50"
              ...
              <button
                ...
                className={`w-full py-4 rounded-xl font-bold text-sm uppercase tracking-wide transition-all duration-300 flex items-center justify-center gap-2 ${
                  isSubmitted
                    ...
                    : 'bg-[#2563eb] hover:bg-[#1d4ed8] text-white shadow-md hover:shadow-lg hover:shadow-orange-200 hover:-translate-y-0.5 active:translate-y-0'
                }`}
              >
                {isSubmitted ? (
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm h-56 flex items-center justify-center relative overflow-hidden">
              ...
              <div className="text-center relative z-10">
                <div className="w-14 h-14 bg-[#2563eb] rounded-full flex items-center justify-center mx-auto mb-3 shadow-lg shadow-orange-200">
                  <MapPin className="w-7 h-7 text-white" />
                </div>
                <p className="text-sm font-bold text-gray-900">Suraksha Market HQ</p>
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1.5 mt-3 text-xs font-semibold text-[#2563eb] hover:underline"
                >
        ...
        <section className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 md:p-12">
          <div className="text-center mb-10">
            <div className="inline-flex items-center gap-2 bg-[#2563eb]/10 border border-[#2563eb]/20 rounded-full px-4 py-1.5 mb-4">
              <span className="text-xs font-semibold text-[#2563eb] uppercase tracking-wider">Common Questions</span>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-5">
            {[
              ...
              },
              {
                ...
                a: "Yes! We offer special pricing for bulk orders (10+ units). Email us at support@surakhshamarket.in for a custom quote."
              },
              {
              ...
              <div key={i} className="bg-gray-50 p-5 rounded-xl border border-gray-100 hover:border-[#2563eb]/20 hover:shadow-sm transition-all duration-200">
        ...
        {/* ── CTA ── */}
        <section className="bg-[#1e40af] rounded-2xl p-12 text-white text-center relative overflow-hidden">
